...
class S1:
    ...
    def set_pexpect_command(self,json_path,json_file,log_path):
        ...
        # with open("{0}/{1}".format(json_path, json_file + ".fazit_clip"), encoding="utf-8") as json_data:
...
class JSON:
    ...
    def saveAsFile(self, file_path, file_name):
        json.dump(self.json_dict, open(file_path + "/" + file_name, 'w'), ensure_ascii=False,
                  indent=4, separators=(", ", " : "))
    # @staticmethod
    # def save_like_a_json(jsonData, fileName='ns1000000.fazit_clip', localPath=os.getcwd() + '/json_sets/'):
    #     return fazit_clip.dump(jsonData, open(localPath + fileName, 'w'), ensure_ascii=False,
    #                      indent=4, separators=(", ", " : "))
...
if __name__ == '__main__':
    ...
    # print(fazit_clip.load(A.json_dict))

    # print("{{}{0}{}}".format((str(A.json_dict))))
    # print(fazit_clip.loads("{{}{0}{}}".format((str(A.json_dict)))))
